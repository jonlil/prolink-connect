use std::{net::{Ipv4Addr, SocketAddr, ToSocketAddrs, UdpSocket}, sync::mpsc::Receiver};
...
impl KeepAliveListener {
    ...
    pub fn run<T: ToSocketAddrs>(address: T) -> Result<(Receiver<(Device, SocketAddr)>), std::io::Error> {
